...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/myprofile-skin-desktop-c70szf--d-webkit-537-d-ltr-d--s-n-c.css">
<style type="text/css">
body {
	padding: 0;
	margin: 0;
...
<body class="x288 x13d p_AFMaximized">
	<form action="${pageContext.request.contextPath}/chreckCode"
