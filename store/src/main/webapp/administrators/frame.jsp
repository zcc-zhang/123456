            ...
            <li>
                ...
                <dl>
                    <dt><a href="javascript:void(0)"
                           onclick="menuCAClick('${pageContext.request.contextPath}/administrators/tgls/goodsManage/goodsType_list.jsp',this)">分类列表</a>
                    </dt>
                    <dt><a href="javascript:void(0)"
                           onclick="menuCAClick('${pageContext.request.contextPath}/administrators/tgls/goodsManage/goods_list.jsp',this)">基本商品库</a>
                    </dt>
                    <dt><a href="javascript:void(0)"
                           onclick="menuCAClick('${pageContext.request.contextPath}/administrators/tgls/goodsManage/goods_add.jsp',this)">添加商品</a>
                    </dt>
                </dl>
            </li>
        </ul>
            ...
            <ul>
                <li>
                    <a href="javascript:void(0)"
                       onclick="menuCAClick('${pageContext.request.contextPath}/administrators/tgls/modify_password.jsp',this)"><i
                            class="iconfont icon-yonghu1"></i>管理员</a>
                </li>
                <li>
                    <a href="javascript:void(0)"
                       onclick="menuCAClick('${pageContext.request.contextPath}/administrators/tgls/modify_password.jsp',this)"><i
                            class="iconfont icon-xiugaimima"></i>修改密码</a>
                </li>
                <li>
                    <a href="javascript:void(0)" id="logout"><i class="iconfont icon-084tuichu"></i>注销</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="frameMain">
        ...
        <div class="con">
            <iframe id="mainIframe"
                    src="${pageContext.request.contextPath}/administrators/tgls/goodsManage/goodsType_list.jsp"
                    scrolling="no"></iframe>
        </div>
    </div>
    <!-- 核心区域 - 结束 -->
...
<script>
    $(() => {
        $("#logout").bind("click", () => {
            window.location.href = "${pageContext.request.contextPath}/manage/frame";
        });
    });
</script>
</html>